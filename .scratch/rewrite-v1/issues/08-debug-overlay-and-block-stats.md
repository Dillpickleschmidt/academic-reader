...
Add the Debug Overlay to both Source View and Reader View. The overlay should make Block structure visible in place with colored boxes/badges, hover details, block type stats, and direct Cross-view Links where the same Block has both Source Geometry and Reader View content.
...
- [ ] Reader View shows Block wrappers/metadata without rewriting `contentHtml`.
