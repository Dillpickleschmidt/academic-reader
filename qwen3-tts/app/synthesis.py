"""Audio synthesis and post-processing for Qwen3-TTS."""
...
def synthesize(
    ...
    # Start loading alignment model in background while Qwen3-TTS generates
    ...
    prompt = torch.load(voice.prompt_path, weights_only=False)
